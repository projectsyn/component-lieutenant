# Commodore Component: Lieutenant

This is a [Commodore][commodore] Component for Lieutenant.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/lieutenant).
